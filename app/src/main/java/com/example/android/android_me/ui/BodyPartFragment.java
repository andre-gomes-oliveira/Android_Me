...
public class BodyPartFragment extends Fragment {
    ...
    private Integer mCurrentResource = 0;

    public void setImageResources(List<Integer> imageResources) {
        this.mImageResources = imageResources;
    }

    public void setCurrentResource(Integer index) {
        this.mCurrentResource = index;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // COMPELTED (3) If a list of image ids exists, set the image resource to the correct item in that list
        // Otherwise, create a Log statement that indicates that the list was not found
        if(!mImageResources.isEmpty())
            imageView.setImageResource(mImageResources.get(mCurrentResource));
        else
            Log.e(TAG, "Could not find a list of resources");
